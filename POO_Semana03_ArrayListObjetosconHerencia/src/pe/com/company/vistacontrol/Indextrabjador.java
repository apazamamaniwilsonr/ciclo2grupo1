 ...
 */
package pe.com.company.vistacontrol;

import java.util.ArrayList;
import pe.com.company.modelo.Trabajador;
import pe.com.company.utils.Lectura;
import pe.com.company.utils.Utilitarios;

/**
 *
 * @author shunn
 */
public class Indextrabjador {
    ...
    public static void datosdeinstalacion(){
        Trabajador t1 = new Trabajador(3000, "Mi casa", "Gerente", 1, "wilson",
        "76183244");
        trabajadores.add(t1);
        ...
        Trabajador t5 = new Trabajador(3000, "Mi casa", "Gerente", 2, "wilson",
        "55512155");
        trabajadores.add(t5);
    }
