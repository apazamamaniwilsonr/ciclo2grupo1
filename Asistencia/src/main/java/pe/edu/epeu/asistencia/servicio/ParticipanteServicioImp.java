...
import pe.edu.epeu.asistencia.repositorio.ParticipanteIRepository;
...
public class ParticipanteServicioImp implements ParticipanteServicioI {
    ...
    @Override
    public Participante update(Participante participante) {return participanteRepository.save(participante);
    }

    @Override
    public void delete(String dni) {participanteRepository.deleteById(dni);
    }
