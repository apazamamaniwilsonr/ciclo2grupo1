...
import pe.com.empresa.modelo.Estudiante;
...
public class indexestudiante {
    ...
    public static void datosdeinstalacion(){
        Estudiante e1 = new Estudiante("202510052", "Ingenieria de Sistemas", 23, "wilson",
        "76183244");
        estudiantes.add(e1);
        ...
        Estudiante e5 = new Estudiante("202510062", "sistemas", 40, "wilson",
        "76183244");
        estudiantes.add(e5);
    }
